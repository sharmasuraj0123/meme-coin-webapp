      ...
      <nav className="w-64 p-8 bg-red-800 text-white flex flex-col justify-between">
        <div>
          <h1 className="text-2xl font-bold mb-8">
            <img alt="PION Logo" className="h-8 w-auto" src="/placeholder.svg" />
          </h1>
          <ul>
        ...
        <Button className="mt-4 border-2 border-white rounded-full bg-transparent">Connect Wallet</Button>
      </nav>
      </div>
    </html>
  );
